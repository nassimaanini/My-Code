...
class Clients extends Controller {
    ...
    public function __construct(ClientRepository $clientrepo) {
        ...
        //Permissions on methods
        $this->middleware('importClientsMiddlewareIndex')->only([
            'store',
        ]);
    ...
    public function store(ImportExportRepository $importexportrepo) {
        ...
        $clients = $this->clientrepo->getImportedClients($import->getRowCount());
        $new_clients = $clients->take($import->getRowCount());
    ...
    private function processCollection() {
        ...
        foreach ($clients as $client) {
            ...
            $user->phone = $client->client_phone;
